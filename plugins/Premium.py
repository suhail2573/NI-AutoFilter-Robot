...
async def plan(client, message):
    ...
    btn = [[
        ...
        InlineKeyboardButton("📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ʜᴇʀᴇ", url="https://t.me/IM_NISHANTT")],[InlineKeyboardButton("ᴄʟᴏꜱᴇ", callback_data="close_data")
    ]]
...
# SPECIAL THANKS TO @IM_NISHANTT FOR MODIFYING THESE AMAZING CODES 
