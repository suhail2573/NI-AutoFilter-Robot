...
from database.nireferdb import referdb
...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_req_subscribed(client, message):
        ...
        btn = [
                [
                    InlineKeyboardButton(
                        "〄 ᴊᴏɪɴ ʙᴀᴄᴋᴜᴘ ᴄʜᴀɴɴᴇʟ 〄", url=invite_link.invite_link
                    )
                ]
        ...
        await client.send_photo(
            ...
            caption="ᴊᴏɪɴ ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ᴀɴᴅ ᴛʜᴇɴ ᴄʟɪᴄᴋ ᴏɴ ᴛʀʏ ᴀɢᴀɪɴ ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ʀᴇǫᴜᴇꜱᴛᴇᴅ ꜰɪʟᴇ.",
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.answer('ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : ₪')
...
async def donate_command(client, message):
    buttons = [
        [
            InlineKeyboardButton("ᴅᴏɴᴀᴛᴇ", url="https://t.me/IM_NISHANTT"),
