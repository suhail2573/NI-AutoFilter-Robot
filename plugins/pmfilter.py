...
async def pm_search(client, message):
 ...
 #   if user_id in ADMINS: return
    ...
    if await db.get_pm_search_status(bot_id):
        ...
        await message.reply_text("<b><i>ʜᴇʏ {user} 🦋 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ꜱᴇᴀʀᴄʜ ɢʀᴏᴜᴘ.</i></b>",
                                 reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ᴍᴏᴠɪᴇ ꜱᴇᴀʀᴄʜ ɢʀᴏᴜᴘ ", url=f'https://t.me/Ni_Movie_Request_Group')]]))
...
async def filter_seasons_cb_handler(client: Client, query: CallbackQuery):
    ...
    if settings["button"]:
        ...
        btn.insert(0, [
            ...
            InlineKeyboardButton("♻️ ꜱᴇʟᴇᴄᴛ ᴀɢᴀɪɴ ♻️", callback_data=f"seasons#{key}")
        ])
    else:
        btn = []
        btn.insert(0, 
        ...
        btn.insert(0, [
            InlineKeyboardButton("♨️ sᴇɴᴅ ᴀʟ ♨️ʟ", callback_data=f"sendfiles#{key}")
        ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        if AUTH_CHANNEL and not await is_req_subscribed(client, query):
            await query.answer("Jᴏɪɴ ᴏᴜʀ ʙᴀᴄᴋᴜᴘ ᴄʜᴀɴɴᴇʟ ᴍᴀʜɴ! 😒", show_alert=True)
            return
        ...
        try:
            ...
            await query.answer(f"☣ Hey Sweetheart, Something Went Wrong \n\n{e}", show_alert=True)
            return
        ...
        buttons = [[
            InlineKeyboardButton('ᴀɴʏ ǫᴜᴇʀʏ', url="https://t.me/Ni_owner_contact_bot")
        ], [
            InlineKeyboardButton('ᴏᴡɴᴇʀ', callback_data='sad'),
            InlineKeyboardButton('ᴀᴅᴍɪɴ ᴄᴏᴍᴍᴀɴᴅꜱ', callback_data='adminx'),
            ...
            InlineKeyboardButton('ʀᴇǫ.. ꜰᴏʀᴍᴀᴛ', callback_data='format'),
        ...
        buttons = [[
            InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ʜᴇʀᴇ', url="https://t.me/IM_NISHANTT")
        ],[
        ...
        btn = [[
            InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ', url="https://t.me/IM_NISHANTT")
        ],[
            InlineKeyboardButton('ᴄʟᴏꜱᴇ', callback_data='close_data')
        ]]
        reply_markup = InlineKeyboardMarkup(btn)
        ...
        buttons = [[
            InlineKeyboardButton('📞 ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ ᴛᴏ ᴋɴᴏᴡ ᴍᴏʀᴇ', url="https://t.me/IM_NISHANTT")
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('ᴍᴏᴠɪᴇ ʀᴇǫᴜᴇꜱᴛ ꜰᴏʀᴍᴀᴛ', callback_data='mformat')
        ],[
            InlineKeyboardButton('ꜱᴇʀɪᴇꜱ ʀᴇǫᴜᴇꜱᴛ ꜰᴏʀᴍᴀᴛ', callback_data='nformat')
        ],[
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='help')
         ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.F_TXT.format(query.from_user.mention),
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
            )
            
                elif query.data == "mformat":
        buttons = [[
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='format')
               ]]
            reply_markup = InlineKeyboardMarkup(buttons)
            await query.message.edit_text(
                text=(script.MINFO),
    ...
    elif query.data == "ni_family":
        buttons = [[
            InlineKeyboardButton('ʙᴀᴄᴋᴜᴘ 🦋', url="https://t.me//Ni_Movies")
       ],[
            InlineKeyboardButton('ᴍᴏᴠɪᴇs ɢʀᴏᴜᴘ 🧞‍♀️', url="t.me/Ni_Movie_Request_Group"),
            InlineKeyboardButton('ᴜᴘʟᴏᴀᴅ ᴜᴘᴅᴀᴛᴇs 📥', url="t.me/Ni_daily_updates")
       ],[
            InlineKeyboardButton('ᴛʀᴇɴᴅɪɴɢ ᴍᴏᴠɪᴇs 🎭', url="https://t.me/+HjQXvFQ9zb01NGZl"),
            InlineKeyboardButton('ᴀɴʏ ǫᴜᴇʀʏ ✉️', url="https://t.me/Ni_owner_contact_bot")
       ],[
            InlineKeyboardButton('⇇ ʙᴀᴄᴋ', callback_data='start')
        ]]
                reply_markup = InlineKeyboardMarkup(buttons)
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.NI_FAMILY.format(query.from_user.mention),
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴏᴡɴᴇʀ',  url="t.me/IM_NISHANTT")
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            ...
            InlineKeyboardButton('sᴛᴀᴛᴜs 📈', callback_data='special'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    if not spoll:
        ...
        if len(message.text) < 100:
            search = message.text
            m=await message.reply_sticker("CAACAgQAAxkBAAIFtmdS3LWlPtqMYIM5QmlaN7pf8FL8AAJuDwAC4eqxUNoxB5joJxGiHgQ",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(f'sᴇᴀʀcʜɪɴɢ ꜰoʀ {search} 🔎', url=f"https://t.me/Ni_Movies")]]) 
            )
            search = search.lower()
            find = search.split(" ")
            search = ""
...
async def advantage_spell_chok(client, msg):
    ...
    btn.append([InlineKeyboardButton(text="✘ cʟosᴇ ✘", callback_data=f'spol#{reqstr1}#close_spellcheck')])
